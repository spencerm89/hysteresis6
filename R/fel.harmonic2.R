...
amps <- derived.amps(b.x,b.y,retention)  
  focus <- derived.focus(inti[3],inti[4],inti[1])
   ...
   z <- c( "b.x"=b.x,"b.y"=b.y,"retention"=retention,
           "lag"=der[2], "coercion"=der[3],"area"=der[1],"phase.angle"=phase.angle, "rote.rad"=inti[1],
          "rote.deg"=inti[2],"semi.major"=inti[3],"semi.minor"=inti[4],"split.angle"=amps[1],
          "hysteresis.x"=amps[2],"hysteresis.y"=amps[3],"ampx"=amps[4],"ampy"=amps[5],"cx"=cx,"cy"=cy,
